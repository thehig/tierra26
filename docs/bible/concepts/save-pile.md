...
## Advanced
Each creature has a **10-slot ring** {save-pile stack} (`STACK_SIZE = 10`) with a stack pointer `sp`:
...
Users of the {save-pile pile}: `pushA/B/C/D` (push a {register}), `popA/B/C/D` (pop into a register — these do
